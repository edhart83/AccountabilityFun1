			...
			<div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
				...
				<main>
					...
					<div
						...
						<h1 class="text-2xl font-semibold">Partner Search</h1>
						<div id="result">
				            <h3>${ message }</h3>
				        </div>
							...
							<c:when test="${not empty userList}">
								<c:forEach var="user" items="${userList}">
									<div
										...
										<div class="card shadow p-1 eFullWidthImage">
											<img class="card-image eCustomCover" width="225px" height="225px" alt=""
												src="resources/images/${ user.imagePath }">
											<div class="card-body eCardBody">
