...
<title>Accountability Partners | Thank You</title>
<link
	...
	<div x-data="setup()"
				...
				<div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
					...
					<div class="jumbotron text-center">
						...
						<p class="lead eCustomP">
							<a class="btn btn-primary btn-sm" href="/login" role="button">Continue
								to Login</a>
						</p>
					</div>
					...
					<div class="flex items-center justify-center space-x-2 flex-nowrap">
						<span class="w-20 h-px bg-gray-300"></span> <span>OR</span> <span
							class="w-20 h-px bg-gray-300"></span>
					</div>
		...
		<div class="fixed bottom-5 left-5">
			<button aria-hidden="true" @click="toggleTheme"
				...
				<svg x-show="isDark" class="w-8 h-8 text-white"
