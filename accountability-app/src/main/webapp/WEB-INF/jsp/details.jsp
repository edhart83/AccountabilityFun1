						...
						<div
							...
							<div class="card shadow p-1">
								...
								<div class="row featurette">
									<div class="col-md-5 eOuterDiv1">
										<img class="card-image eCustomCoverDetails" width="225px"
											height="225px" alt=""
											src="resources/images/${ user.imagePath }">
									...
									<div class="col-md-7 eOuterDiv2">
										<h2 class="featurette-heading eFeaturetteHeading">
											${ user.firstName } ${ user.lastName }'s <span
												class="text-muted">Profile</span>
										</h2>
										<p class="lead eLead">${ user.biography }</p>
									</div>
								...
								<div class="row">
									<div class="d-flex justify-content-center">
										<div class="btn-group eButtonGroupDiv">
											<a href="/partner-search" type="button"
												class="btn btn-primary">Return</a> <a href="#" type="button"
												class="btn btn-success eButtonGroup">Message</a> <a
												href="/favorites?id=${ user.email }" type="button"
												class="btn btn-warning eButtonGroup">Save to Favorites</a> <a
												href="#" type="button"
												class="btn btn-secondary eButtonGroup">Skip for Now</a> <a
												href="#" type="button" class="btn btn-danger eButtonGroup">Hide
												Forever</a>
										</div>
									</div>
								</div>
